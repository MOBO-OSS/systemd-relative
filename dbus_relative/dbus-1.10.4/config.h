...
#define DBUS_TEST_EXEC "/usr/OSS/systemd_relative/dbus_relative/dbus-1.10.4/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/usr/OSS/systemd_relative/dbus_relative/dbus-1.10.4/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.10.4"
...
#define TEST_BUS_LAUNCH_BINARY "/usr/OSS/systemd_relative/dbus_relative/dbus-1.10.4/tools/dbus-launch"
